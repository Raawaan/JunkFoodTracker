...
class AbstractFrag:android.support.v4.app.Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewPager.adapter=MyAdapter(childFragmentManager,activity!!.applicationContext)
        tabLayout.post({
    ...
    class MyAdapter(fragmentManager: FragmentManager,val context: Context) : FragmentPagerAdapter(fragmentManager){
